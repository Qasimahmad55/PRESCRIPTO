...
const stripe = new Stripe(process.env.STRIPE_SECRET_KEY)//instance
...
export { registerUser, loginUser, getProfile, updateUserProfile, bookAppointment, listAppointment, cancelAppointment, StripePayment }